...
const TEST_USERS_DATA = [
    ...
    { empNum: '100000006', name: 'Siti Nurhaliza', email: 'siti.nur@test.com', nik: '3201011991020002', npwp: '1234567890123462' },
    { empNum: '100000007', name: 'Ahmad Dahlan', email: 'ahmad.dahlan@test.com', nik: '3201011992030003', npwp: '1234567890123463' },
    { empNum: '100000008', name: 'Rina Wijaya', email: 'rina.wijaya@test.com', nik: '3201011993040004', npwp: '1234567890123464' },
    { empNum: '100000009', name: 'Joko Widodo', email: 'joko.widodo@test.com', nik: '3201011994050005', npwp: '1234567890123465' },
    // Waiting Ketua Approval
    { empNum: '100000010', name: 'Dewi Sartika', email: 'dewi.sartika@test.com', nik: '3201011995060006', npwp: '1234567890123466' },
    { empNum: '100000011', name: 'Andi Setiawan', email: 'andi.setiawan@test.com', nik: '3201011996070007', npwp: '1234567890123467' },
    { empNum: '100000012', name: 'Sri Mulyani', email: 'sri.mulyani@test.com', nik: '3201011997080008', npwp: '1234567890123468' },
    { empNum: '100000013', name: 'Bambang Pamungkas', email: 'bambang.p@test.com', nik: '3201011998090009', npwp: '1234567890123469' },
    // Approved members
    { empNum: '100000014', name: 'Mega Wati', email: 'mega.wati@test.com', nik: '3201011999100010', npwp: '1234567890123470' },
    { empNum: '100000015', name: 'Hendra Gunawan', email: 'hendra.g@test.com', nik: '3201012000110011', npwp: '1234567890123471' },
    { empNum: '100000016', name: 'Lestari Indah', email: 'lestari.indah@test.com', nik: '3201012001120012', npwp: '1234567890123472' },
    { empNum: '100000017', name: 'Rizki Ramadhan', email: 'rizki.r@test.com', nik: '3201012002130013', npwp: '1234567890123473' },
    { empNum: '100000018', name: 'Fitri Handayani', email: 'fitri.h@test.com', nik: '3201012003140014', npwp: '1234567890123474' },
    { empNum: '100000019', name: 'Arief Budiman', email: 'arief.b@test.com', nik: '3201012004150015', npwp: '1234567890123475' },
    // Rejected
    { empNum: '100000020', name: 'Doni Pratama', email: 'doni.p@test.com', nik: '3201012005160016', npwp: '1234567890123476' },
    { empNum: '100000021', name: 'Yuni Shara', email: 'yuni.shara@test.com', nik: '3201012006170017', npwp: '1234567890123477' },
    { empNum: '100000022', name: 'Wawan Setiawan', email: 'wawan.s@test.com', nik: '3201012007180018', npwp: '1234567890123478' },
];
...
export async function seedUsers(ctx: SeederContext): Promise<void> {
    ...
    for (const testData of TEST_USERS_DATA) {
        ...
        if (userByEmployee) {
            // If linked user exists but has different email, we might have a conflict or dirty DB
            // We will just use this user and update context
            if (userByEmployee.email !== testData.email) {
                console.warn(`Employee ${testData.empNum} already linked to user ${userByEmployee.email}. Using existing user.`);
            }
