        ...
        for (const withdrawal of withdrawals) {
            try {
                ...
                if (user.savingsAccount.saldoSukarela.lessThan(withdrawalAmount)) {
                    this.logger.warn(`User ${user.name} saldo sukarela kurang dari withdrawal amount!`);
                    throw new Error(`User ${user.name} saldo sukarela kurang dari withdrawal amount!`);
                }
