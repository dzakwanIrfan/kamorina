          ...
          <TabsContent value="details" className="space-y-6 mt-6">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {withdrawal.user?.employee?.employeeNumber}
                    </p>
                  </div>
                  <div>
            ...
            <div className="rounded-lg border p-4 space-y-3">
              ...
              <div className="space-y-4">
                  ...
                  <div className="rounded-lg border border-orange-500 bg-orange-50 dark:bg-orange-950/20 p-3 space-y-2">
                    <div className="flex items-center gap-2 text-orange-900 dark:text-orange-100">
                      ...
                      <span className="font-semibold text-sm">
                        Pinalti Deposito Belum Jatuh Tempo
                      </span>
                    </div>
                ...
                {withdrawal.user?.employee?.bankAccountName && (
                  <div className="flex justify-between items-center text-sm">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                {withdrawal.submittedAt && (
                  <div>
                    ...
                    <p className="font-medium">
                      {format(
                        new Date(withdrawal.submittedAt),
                        "dd MMMM yyyy HH:mm",
                        {
                          locale: id,
                        }
                ...
                {withdrawal.disbursement && (
                  <div>
                    ...
                    <p className="font-medium">
                      {format(
                        new Date(withdrawal.disbursement.disbursementDate),
                        "dd MMMM yyyy",
                        { locale: id }
                      )}
                      {withdrawal.disbursement.disbursementTime &&
                        ` ${withdrawal.disbursement.disbursementTime}`}
                    </p>
                  </div>
                )}
                {withdrawal.authorization && (
                  <div>
                    ...
                    <p className="font-medium">
                      ...
                      {withdrawal.authorization.authorizationTime &&
                        ` ${withdrawal.authorization.authorizationTime}`}
                    </p>
                  </div>
                )}
                {withdrawal.completedAt && (
                  <div>
                    ...
                    <p className="font-medium">
                      {format(
                        new Date(withdrawal.completedAt),
                        "dd MMMM yyyy HH:mm",
                        {
                          locale: id,
                        }
            ...
            {/* Rejection Reason */}
            {withdrawal.status === SavingsWithdrawalStatus.REJECTED &&
              ...
              {(() => {
                ...
                return timelineSteps.map((item, index) => {
                  ...
                  if (item.type === "approval") {
                    const approval = withdrawal.approvals.find(
                      (a) => a.step === item.step
                    );
                    if (approval) {
                      status =
                      ...
                      withdrawal.currentStep === item.step &&
                      withdrawal.status !== SavingsWithdrawalStatus.REJECTED
                    ) {
                      status = "current";
                    } else if (
                    ...
                    if (withdrawal.authorization) {
                      ...
                      actorName =
                        withdrawal.authorization.authorizedByUser.name;
