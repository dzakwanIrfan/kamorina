...
interface BulkProcessDisbursementDialogProps {
  open: boolean;
...
export function BulkProcessDisbursementDialog({
  open,
  onOpenChange,
  selectedIds,
  onSuccess,
}: BulkProcessDisbursementDialogProps) {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      const result = await loanService.bulkProcessDisbursement({
        loanIds: selectedIds,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>Proses Pencairan Massal</DialogTitle>
          <DialogDescription>
            Konfirmasi pencairan untuk {selectedIds.length} pinjaman sekaligus
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Tambahkan catatan untuk semua pencairan..."
                      rows={3}
                      {...field}
                      disabled={isSubmitting}
                    />
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={isSubmitting}>
                ...
                Konfirmasi {selectedIds.length} Pencairan
              </Button>
            </DialogFooter>
          </form>
        </Form>
