...
interface ProcessAuthorizationDialogProps {
...
export function ProcessAuthorizationDialog({
  loan,
  open,
  onOpenChange,
  onSuccess,
}: ProcessAuthorizationDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Konfirmasi Otorisasi</DialogTitle>
          <DialogDescription>
            Masukkan tanggal dan jam otorisasi yang sudah dilakukan
          </DialogDescription>
        </DialogHeader>
        ...
        {loan.disbursement && (
          <div className="rounded-lg border border-green-200 bg-green-50 dark:bg-green-950/30 p-4">
            <h4 className="font-semibold mb-3 text-green-900 dark:text-green-300">
              Info Pencairan (dari Shopkeeper)
            </h4>
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
